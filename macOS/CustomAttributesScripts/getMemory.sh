...
############################################################################################
# Extension Attribute script to return the Physical Memory of the Mac as a string
############################################################################################
...
memory=$(/usr/sbin/system_profiler SPHardwareDataType | /usr/bin/grep -E Memory)
