...
$null = (New-ItemProperty -LiteralPath $RegistryPath -Name 'DisableLogonBackgroundImage' -Value 1 -PropertyType DWord -Force -Confirm:$false -ErrorAction SilentlyContinue)
